          ...
          <form method="post" onSubmit={remove}>
            <div className="row">
              <div className="mb-3 col-md-6 col-lg-4">
                ...
                <input readOnly id="order_detail_order_id" name="order_id" className="form-control form-control-sm" value={orderDetail.order_id || '' } type="number" required />
              </div>
              <div className="mb-3 col-md-6 col-lg-4">
              ...
              <div className="mb-3 col-md-6 col-lg-4">
                ...
                <input readOnly id="product_name" name="product_name" className="form-control form-control-sm" value={orderDetail.product_name || '' } maxLength="50" />
              </div>
              <div className="mb-3 col-md-6 col-lg-4">
